...
public class RenderResolveOutputGroupProviderTest extends BlazeTestCase {
  ...
  private final MockAspectStrategy aspectStrategy = new MockAspectStrategy();
  ...
  /**
   * Test intellij-render-resolve-android is included when android language is enabled and "resolve"
   * output group is attached
   */
  @Test
  ...
  /** Test intellij-render-resolve-android is skipped when android language is not enabled */
  @Test
  ...
  /**
   * Test intellij-render-resolve-android is skipped when "resolve" output groups is not attached
   */
  @Test
